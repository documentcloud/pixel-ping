(function(){
  var Buffer, _a, config, configPath, emptyHeaders, endHeaders, endParams, endpoint, flush, fs, http, js, jsHeaders, jsPath, log, pixel, pixelHeaders, querystring, record, serialize, server, store, url;
  ...
  jsPath = url.format({
    host: config.host,
    port: config.proxy_port || config.port,
    protocol: 'http:'
  });
