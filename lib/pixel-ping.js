...
var VERSION, config, configPath, emptyHeaders, endParams, endReqOpts, flush, fs, http, log, pixel, pixelHeaders, querystring, record, reset, serialize, server, store, url;
