...
(function() {
  var VERSION, config, configPath, emptyHeaders, endParams, endReqOpts, flush, fs, http, https, httpsPattern, log, pixel, pixelHeaders, querystring, record, reset, serialize, server, store, url;
