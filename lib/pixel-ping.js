(function() {
  var config, configPath, emptyHeaders, endHeaders, endParams, endpoint, flush, fs, http, js, jsHeaders, jsPath, log, pixel, pixelHeaders, querystring, record, serialize, server, store, url;
